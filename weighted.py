...
def single_source_dijkstra(G,source,mac_dict,target=None,cutoff=None,weight='weight'):
     ...
     #   print edata
        ...
        #    print w,edgedata
            ...
            if w in dist:
                ...
                previous_node = paths[w][len(paths[w])-2]
                print w, v,previous_node, mac_dict[v],mac_dict[previous_node]

                if mac_dict[v] < mac_dict[previous_node]: #checking mac_address
                #    print paths[w]
                 #   print "change path",paths[previous_node]
